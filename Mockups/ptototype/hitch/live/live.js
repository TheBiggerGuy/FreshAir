...
// Adding jplayer will cause an unknow error !!!
/*
...
/** @const */ var TIMEOUT_WEBCAM     = 3*1000
...
$(function() { // executed when $(document).ready()
  ...
  // hack so iphone does not show the url bar
  scrollTo(0, 1); // scroll 1 pixel
...
function updateInfo() {
  ...
  jQuery.ajax(
    {
      url: "http://www.freshair.org.uk/dev/live.php?action=getinfo",
      dataType: "json",
